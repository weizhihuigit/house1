        ...
        $(function(){
            ...
            $('#dg').datagrid({
                ...
                columns:[[
                    ...
                    {field:'name',title:'用户信息',width:300,align:'left'},
                    {field:'telephone',title:'电话',width:300,align:'left'},
                    {field:'s',title:'操作',width:200,align:'left',
                        formatter:function (value,row,index) {
                            var str="<a href='javascript:delUsers("+row.id+")'>删除</a>|<a href='javascript:updateDialog()'>修改</a>"
                            return str;
                        }}
                ]]
            });
            ...
            if(SelectRows.length==0){
                ...
                $.messager.confirm('>>提示','确定删除吗?想好在点!',function(r){
                    if(r){  //删除
                        ...
                        //4.发送异步请求到服务器实现删除
                        $.post("delMoreUsers",{"ids":val},function(data){
                            if(data.result>0){
                                //刷新datagrid
                                $('#dg').datagrid("reload");
                            } else{
...
<div id="AddDialog" class="easyui-dialog" buttons="#AddDialogButtons"
    ...
    <form method="post" action="addDistrict" id="form1" name="form1">
        用户名称:<input type="text" name="name" id="name2"><br>
        用户电话:<input type="text" name="telephone"><br>
        用户：<input type="text" name="isadmin">
...
<div id="updateDialog" class="easyui-dialog" buttons="#updateDialogButtons"
    ...
    <form method="post" action="updateDialog" id="form2" name="form1">
        ...
        用户名称:<input type="text" name="name" id="name3"><br>
        用户电话:<input type="text" name="telephone" >
